import { c as createComponent, r as renderTemplate, m as maybeRenderHead, d as addAttribute, a as renderSlot, e as createAstro, j as renderScript, b as renderComponent, s as spreadAttributes, u as unescapeHTML, k as renderHead } from './astro/server_Cbs_mLla.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                         */
...
}, "C:/Users/Usuario/Desktop/Files/Work/Github proyects/portfolio-astro-react/src/components/Hero.astro", void 0);
...
}, "C:/Users/Usuario/Desktop/Files/Work/Github proyects/portfolio-astro-react/node_modules/astro/components/ClientRouter.astro", void 0);
...
const $$MainHead = createComponent(($$result, $$props, $$slots) => {
  ...
  const {
    title = "Ceradev",
    description = "A blog about web development, design, and other things."
  } = Astro2.props;
...
<\/script>`])), addAttribute(description, "content"), addAttribute(Astro2.generator, "content"), title, renderComponent($$result, "ClientRouter", $$ClientRouter, {}));
}, "C:/Users/Usuario/Desktop/Files/Work/Github proyects/portfolio-astro-react/src/components/MainHead.astro", void 0);
...
const $$Icon = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Icon;
  const { color = "currentcolor", gradient, icon, size, library } = Astro2.props;
  ...
  const iconPath = !isReactIcon ? iconPaths[icon] : null;
  const IconComponent = isReactIcon ? reactIconLibraries[library][icon] : null;
  const attrs = {};
  if (size) attrs.style = { "--size": size };
  const gradientId = "icon-gradient-" + Math.round(Math.random() * 1e13).toString(36);
  return renderTemplate`${!isReactIcon ? (
    // Renderiza un ícono SVG
    renderTemplate`${maybeRenderHead()}<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 256 256" aria-hidden="true"${addAttribute(gradient ? `url(#${gradientId})` : color, "stroke")}${addAttribute(gradient ? `url(#${gradientId})` : color, "fill")}${spreadAttributes(attrs, void 0, { "class": "astro-patnjmll" })} data-astro-cid-patnjmll><g data-astro-cid-patnjmll>${unescapeHTML(iconPath)}</g>${gradient && renderTemplate`<linearGradient${addAttribute(gradientId, "id")} x1="23" x2="235" y1="43" y2="202" gradientUnits="userSpaceOnUse" data-astro-cid-patnjmll><stop stop-color="var(--gradient-stop-1)" data-astro-cid-patnjmll></stop><stop offset=".5" stop-color="var(--gradient-stop-2)" data-astro-cid-patnjmll></stop><stop offset="1" stop-color="var(--gradient-stop-3)" data-astro-cid-patnjmll></stop></linearGradient>`}</svg>`
  ) : (
    // Renderiza un ícono de react-icons
    renderTemplate`<div${spreadAttributes(attrs, void 0, { "class": "astro-patnjmll" })} data-astro-cid-patnjmll>${renderComponent($$result, "IconComponent", IconComponent, { "color": color, "style": { width: "100%", height: "100%" }, "data-astro-cid-patnjmll": true })}</div>`
  )}`;
}, "C:/Users/Usuario/Desktop/Files/Work/Github proyects/portfolio-astro-react/src/components/Icon.astro", void 0);

const $$ThemeToggle = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "theme-toggle", "theme-toggle", { "data-astro-cid-x3pjskd3": true }, { "default": () => renderTemplate` ${maybeRenderHead()}<button data-astro-cid-x3pjskd3> <span class="sr-only" data-astro-cid-x3pjskd3>Toggle theme</span> <span class="icon light" data-astro-cid-x3pjskd3>${renderComponent($$result, "Icon", $$Icon, { "icon": "sun", "data-astro-cid-x3pjskd3": true })}</span> <span class="icon dark" data-astro-cid-x3pjskd3>${renderComponent($$result, "Icon", $$Icon, { "icon": "moon-stars", "data-astro-cid-x3pjskd3": true })}</span> </button> ` })}  ${renderScript($$result, "C:/Users/Usuario/Desktop/Files/Work/Github proyects/portfolio-astro-react/src/components/ThemeToggle.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/Users/Usuario/Desktop/Files/Work/Github proyects/portfolio-astro-react/src/components/ThemeToggle.astro", void 0);
...
const $$Nav = createComponent(($$result, $$props, $$slots) => {
  ...
  const iconLinks = [
    { label: "GitHub", href: "https://github.com/ceradev", icon: "github-logo" },
    { label: "LinkedIn", href: "https://linkedin.com/in/c\xE9sar-aramis-su\xE1rez-orizondo", icon: "linkedin-logo" },
    { label: "CodePen", href: "https://codepen.io/ceradev", icon: "codepen-logo" }
  ];
...
ceradev
  ...
  ], "class:list")}${addAttribute(href, "href")} data-astro-cid-dmqpwcec> ${label} </a> </li>`)} </ul> <div class="menu-footer" data-astro-cid-dmqpwcec> <div class="socials" data-astro-cid-dmqpwcec> ${iconLinks.map(({ href, icon, label }) => renderTemplate`<a${addAttribute(href, "href")} class="social" target="_blank" rel="noopener noreferrer" data-astro-cid-dmqpwcec> <span class="sr-only" data-astro-cid-dmqpwcec>${label}</span> ${renderComponent($$result, "Icon", $$Icon, { "icon": icon, "data-astro-cid-dmqpwcec": true })} </a>`)} </div> <div class="theme-toggle" data-astro-cid-dmqpwcec> ${renderComponent($$result, "ThemeToggle", $$ThemeToggle, { "data-astro-cid-dmqpwcec": true })} </div> </div> </div> </nav> ${renderScript($$result, "C:/Users/Usuario/Desktop/Files/Work/Github proyects/portfolio-astro-react/src/components/Nav.astro?astro&type=script&index=0&lang.ts")} `;
}, "C:/Users/Usuario/Desktop/Files/Work/Github proyects/portfolio-astro-react/src/components/Nav.astro", void 0);

const $$Footer = createComponent(($$result, $$props, $$slots) => {
  const currentYear = (/* @__PURE__ */ new Date()).getFullYear();
  return renderTemplate`${maybeRenderHead()}<footer data-astro-cid-sz7xmlte> <div class="group" data-astro-cid-sz7xmlte> <p data-astro-cid-sz7xmlte>&copy; ${currentYear} César A. Suárez Orizondo</p> </div> <p class="socials" data-astro-cid-sz7xmlte> <a href="https://github.com/ceradev" target="_blank" data-astro-cid-sz7xmlte> GitHub</a> <a href="https://codepen.io/ceradev" target="_blank" data-astro-cid-sz7xmlte> CodePen</a> <a href="https://linkedin.com/in/césar-aramis-suárez-orizondo" target="_blank" data-astro-cid-sz7xmlte> Linkedin</a> </p> </footer> `;
}, "C:/Users/Usuario/Desktop/Files/Work/Github proyects/portfolio-astro-react/src/components/Footer.astro", void 0);
...
}, "C:/Users/Usuario/Desktop/Files/Work/Github proyects/portfolio-astro-react/node_modules/@vercel/analytics/dist/astro/index.astro", void 0);
...
}, "C:/Users/Usuario/Desktop/Files/Work/Github proyects/portfolio-astro-react/node_modules/@vercel/speed-insights/dist/astro/index.astro", void 0);
